...
class RoleValidator {
    async roleCreateValidator(req, res, next) {
    ...
    async roleUpdateValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            roleUid: Joi.string().required(),
            name: Joi.string().required(),
            permissions: Joi.array()
                .items(Joi.string().required()) // Each item in the array must be a string and is required
                .min(1) // Minimum number of items in the array should be 1
    ...
    async moduleCreateValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            name: Joi.string().required(),
            permissions: Joi.array()
    ...
    async roleUidValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            roluUid: Joi.string().required(),
        });
    ...
    async roleUidsValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            roleUuids: Joi.array()
                .items(Joi.string().required()) // Each item in the array must be a string and is required
