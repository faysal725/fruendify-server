...
class DietValidator {
    async dietCreateValidator(req, res, next) {
    ...
    async dietUpdateValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            dietUid: Joi.string().required(),
            title: Joi.string().required(),
        });
    ...
    async dietUidValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            dietUid: Joi.string().required(),
        });
    ...
    async dietUidsValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            dietUuids: Joi.array()
