...
class LanguageValidator {
    async languageCreateValidator(req, res, next) {
    ...
    async languageUpdateValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            languageUid: Joi.string().required(),
            title: Joi.string().required(),
        });
    ...
    async languageUidValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            languageUid: Joi.string().required(),
        });
    ...
    async languageUidsValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            languageUuids: Joi.array()
