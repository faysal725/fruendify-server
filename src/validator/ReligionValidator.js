...
class ReligionValidator {
    async religionCreateValidator(req, res, next) {
    ...
    async religionUpdateValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            religionUid: Joi.string().required(),
            title: Joi.string().required(),
        });
    ...
    async religionUidValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            religionUid: Joi.string().required(),
        });
    ...
    async religionUidsValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            religionUuids: Joi.array()
