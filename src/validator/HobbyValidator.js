...
class HobbyValidator {
    async hobbyCreateValidator(req, res, next) {
    ...
    async hobbyUpdateValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            hobbyUid: Joi.string().required(),
            title: Joi.string().required(),
        });
    ...
    async hobbyUidValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            hobbyUid: Joi.string().required(),
        });
    ...
    async hobbyUidsValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            hobbyUuids: Joi.array()
