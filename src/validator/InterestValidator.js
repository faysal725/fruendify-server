...
class InterestValidator {
    async interestCreateValidator(req, res, next) {
    ...
    async interestUpdateValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            interestUid: Joi.string().required(),
            title: Joi.string().required(),
        });
    ...
    async interestUidValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            interestUid: Joi.string().required(),
        });
    ...
    async interestUidsValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            interestUuids: Joi.array()
