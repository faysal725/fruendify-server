...
class IndustryValidator {
    async industryCreateValidator(req, res, next) {
    ...
    async industryUpdateValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            industryUid: Joi.string().required(),
            title: Joi.string().required(),
        });
    ...
    async industryUidValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            industryUid: Joi.string().required(),
        });
    ...
    async industryUidsValidator(req, res, next) {
        // create schema object
        const schema = Joi.object({
            industryUuids: Joi.array()
...
module.exports = IndustryValidator;
